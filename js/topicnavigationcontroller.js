define(["require", "exports", 'kokilogic', 'topicnavigationviewmodel', 'topic', 'synchronizers/tsynchronizers', 'command', 'windows'], function (require, exports, KokiLogic, ViewModel, Topic, TSync, Commands, Windows) {
    ...
    var ModelCommunicatorController = (function () {
        function ModelCommunicatorController(model, communicator) {
            ...
            this.subscriptions = [
                ...
                model.selectedTopic.subscribe(function (topic) { return _this.onSelectedTopicChanged(topic); }),
            ];
    ...
    var ModelViewModelController = (function () {
        function ModelViewModelController(model, viewModel, commandProcessor) {
            ...
            this.childTopicCommandControl.commandProcessor.chain.append(function (cmd) { return _this.handleChildTopicCommand(cmd); });
            this.breadcrumbTopicCommandControl.commandProcessor.chain.append(function (cmd) { return _this.handleBreadcrumbTopicCommand(cmd); });
            this.kokiCommandControl.commandProcessor.chain.append(function (cmd) { return _this.handleKokiCommand(cmd); });
            this.kokiCommandControl.commandProcessor.parent = commandProcessor;
            this.viewModelHistory = ko.observableArray();
            viewModel.breadcrumb = ko.computed(function () { return _this.viewModelHistory().slice(0, -1); });
            viewModel.selected = ko.computed(function () { return _this.viewModelHistory().get(-1); });
    ...
    var KokiItemViewModelController = (function () {
        function KokiItemViewModelController(model, viewModel, commandControl) {
            this.viewModel = viewModel;
            this.viewModel.caption = ko.computed(function () { return model.general().title() ? model.general().title() : model.general().text(); });
