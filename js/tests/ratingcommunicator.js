    ...
    var TestClass = (function (_super) {
        ...
        TestClass.prototype.rateNonexistentRatable = function () {
            ...
            com.ratingSubmissionFailed.subscribe(function (args) {
                test.assert(function () { return args.ratableId == 2; });
                ++ctr;
            });
        ...
        TestClass.prototype.submitRatingAndReceiveNewValue = function () {
            ...
            com.ratingSubmitted.subscribe(function (args) {
                test.assert(function () { return args.ratableId == 2; });
                test.assert(function () { return args.rating == 'stronglike'; });
                ++ctr;
            });
            com.submitRating(2, 'stronglike');
            test.assert(function () { return ctr == 1; });
        ...
        TestClass.prototype.queryRating = function () {
            ...
            com.ratingReceived.subscribe(function (args) {
                ++ctr;
                test.assert(function () { return args.ratableId == 10; });
                test.assert(function () { return args.rating.personalRating() == 'like'; });
            });
            com.queryRating(10);
            test.assert(function () { return ctr == 1; });
        };
