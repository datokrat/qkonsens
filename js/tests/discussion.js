...
define(["require", "exports", 'tests/tsunit', 'tests/test', '../discussion', 'tests/testdiscussioncommunicator', '../comment'], function (require, exports, unit, test, Discussion, DiscussionCommunicator, Comment) {
    var TestClass = (function (_super) {
        ...
        TestClass.prototype.discussionCommunicator = function () {
            var _this = this;
            test.assert(function (v) { return v.val(_this.communicator.content) != null; });
        };
        TestClass.prototype.queryComments = function () {
            ...
            this.communicator.commentsReceived.subscribe(function (args) {
                test.assert(function () { return args.id == 2; });
                test.assert(function () { return args.comments.length == 1; });
                test.assert(function () { return ctr == 0; });
                ++ctr;
            });
            this.communicator.queryCommentsOf(2);
            test.assert(function () { return ctr == 1; });
        };
        TestClass.prototype.queryCommentsOfNonExistantId = function () {
            var errorCtr = 0;
            var receivedCtr = 0;
            this.communicator.commentsReceived.subscribe(function () { return ++receivedCtr; });
            this.communicator.commentsReceiptError.subscribe(function () { return ++errorCtr; });
            this.communicator.queryCommentsOf(3);
            test.assert(function () { return errorCtr == 1; });
            test.assert(function () { return receivedCtr == 0; });
        };
        TestClass.prototype.receiveCommentsFromCommunicator = function () {
            ...
            test.assert(function () { return _this.model.comments.get().length == 1; });
        };
        TestClass.prototype.appendComment = function () {
            ...
            this.communicator.commentAppended.subscribe(function (args) { return ++successCtr; });
            this.communicator.commentAppendingError.subscribe(function (args) { return ++errorCtr; });
            this.communicator.appendComment(2, comment);
            test.assert(function () { return successCtr == 1; });
            test.assert(function () { return errorCtr == 0; });
            this.communicator.commentsReceived.subscribe(function (args) {
                ++receiptCtr;
                test.assert(function () { return args.comments.length == 1; });
            });
            this.communicator.queryCommentsOf(2);
            test.assert(function () { return receiptCtr == 1; });
        };
        TestClass.prototype.communicatorRemoveComment = function () {
            ...
            this.communicator.commentRemoved.subscribe(function (args) { return ++successCtr; });
            this.communicator.commentRemovalError.subscribe(function (args) { return ++errorCtr; });
            this.communicator.removeComment({ discussableId: 2, commentId: 10 });
            test.assert(function () { return successCtr == 1; });
            test.assert(function () { return errorCtr == 0; });
            test.assert(function () { return serverDiscussable.discussion().comments.get().length == 0; });
        };
        ...
        TestClass.prototype.controllerRemoveComment = function () {
            ...
            test.assert(function () { return viewModel.comments().length == 0; });
        };
        return TestClass;
    })(unit.TestClass);
    return TestClass;
