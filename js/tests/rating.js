    ...
    var TestClass = (function (_super) {
        ...
        TestClass.prototype.submitRating = function (async, r, cb) {
            ...
            commandProcessor.chain.append(cb(function (cmd) {
                counter.inc('command');
                test.assert(function () { return cmd instanceof Rating.SelectRatingCommand; });
                var castCmd = cmd;
                test.assert(function () { return castCmd.ratingValue == 'like'; });
                castCmd.then();
                test.assert(function () { return mdl.personalRating() == 'like'; });
                return true;
            }));
            vm.select('like')();
        ...
        TestClass.prototype.submitLikeRating = function (async, r, cb) {
            ...
            commandProcessor.chain.append(cb(function (cmd) {
                counter.inc('command');
                test.assert(function (v) { return cmd instanceof Rating.SelectLikeRatingCommand; });
                var typedCmd = cmd;
                test.assert(function (v) { return typedCmd.ratingValue == 'dislike'; });
                typedCmd.then && typedCmd.then();
                test.assert(function (v) { return v.val(mdl.personalRating()) == 'dislike'; });
                return true;
            }));
            vm.select('dislike')();
            setTimeout(cb(function () {
        ...
        TestClass.prototype.summarizedRatingsMVSync = function () {
            ...
            test.assert(function () { return vm.summarizedRatings().like() == 3; });
        };
        TestClass.prototype.summarizedLikeRatingsMVSync = function () {
            ...
            test.assert(function (v) { return vm.summarizedRatings().like() == 6; });
        };
        return TestClass;
    })(unit.TestClass);
