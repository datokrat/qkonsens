...
define(["require", "exports", 'tests/tsunit', 'tests/test', '../konsenskistemodel', '../kernaussagemodel'], function (require, exports, unit, test, koki, ka) {
    var Tests = (function (_super) {
        ...
        Tests.prototype.testChildKaArray = function () {
            ...
            test.assert(function () { return konsenskiste.childKas.get()[0] == kernaussage; });
        };
        Tests.prototype.testRemoveKa = function () {
            ...
            test.assert(function () { return konsenskiste.childKas.get().length == 0; });
        };
        Tests.prototype.testRemoveKa2 = function () {
            ...
            test.assert(function () { return konsenskiste.childKas.get().length == 1; });
        };
        Tests.prototype.testKaEvents = function () {
            ...
            var insertionListener = function (ka) {
                test.assert(function () { return ka == kernaussage; });
                ++insertionCtr;
            };
            var removalCtr = 0;
            ...
            test.assert(function () { return konsenskiste.childKas.get().length == 1; });
            test.assert(function () { return konsenskiste.childKas.get()[0] == kernaussage; });
            test.assert(function () { return insertionCtr == 1; });
            test.assert(function () { return removalCtr == 0; });
            konsenskiste.childKas.remove(kernaussage);
            test.assert(function () { return konsenskiste.childKas.get().length == 0; });
            test.assert(function () { return insertionCtr == 1; });
            test.assert(function () { return removalCtr == 1; });
        };
        Tests.prototype.set = function () {
            ...
            kModel2.set(kModel);
            test.assert(function () { return kModel.childKas.get().length == 1; });
            test.assert(function () { return kModel2.childKas.get().length == 1; });
            kModel2.set(kModel);
            test.assert(function () { return kModel.childKas.get().length == 1; });
            test.assert(function () { return kModel2.childKas.get().length == 1; });
        };
