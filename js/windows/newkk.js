...
define(["require", "exports", '../frame', '../controller', '../kokilogic'], function(require, exports, frame, MainController, KokiLogic) {
    ...
    var Model = (function () {
        ...
        Model.prototype.onClickSubmit = function () {
            var _this = this;
            this.commandProcessor.processCommand(new MainController.CreateNewKokiCommand({ title: this.kokiData.title(), text: this.kokiData.text() }, this.parentTopic().id, function (id) {
                return _this.commandProcessor.processCommand(new KokiLogic.SelectAndLoadKokiCommand(id));
            }));
        };
