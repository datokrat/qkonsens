...
define(["require", "exports", 'command', 'memory', 'windows/konsenskiste', 'windows/konsenskistecontroller', 'windows', 'statelogic', 'accountlogic'], function (require, exports, Commands, Memory, KonsenskisteWin, KonsenskisteWinController, Windows, StateLogic, AccountLogic) {
    var Controller = (function () {
        ...
        Controller.prototype.initCommandProcessors = function () {
            ...
            this.commandProcessor.chain.append(function (cmd) {
                ...
                if (cmd instanceof LoadEnvironsCommand)
                    return _this.onLoadEnvironsCommandReceived(cmd);
            });
        ...
        Controller.prototype.initKonsenskisteModel = function () {
            var _this = this;
            this.konsenskisteModel.subscribe(function (kokiModel) { return _this.onKonsenskisteModelChanged(kokiModel); });
        };
        ...
        Controller.prototype.onLoadEnvironsCommandReceived = function (cmd) {
    ...
    var LoadEnvironsCommand = (function (_super) {
        __extends(LoadEnvironsCommand, _super);
        function LoadEnvironsCommand(kElementID, success) {
            _super.call(this);
            this.kElementID = kElementID;
            this.success = success;
        }
        return LoadEnvironsCommand;
    })(Commands.Command);
    exports.LoadEnvironsCommand = LoadEnvironsCommand;
});
