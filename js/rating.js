...
define(["require", "exports", 'command'], function (require, exports, Commands) {
    ...
    var Controller = (function () {
        function Controller(model, viewModel, args) {
            ...
            viewModel.select = function (rating) { return function () { return setTimeout(function () {
                args.commandProcessor.processCommand(new SelectRatingCommand(rating, function () { return _this.onRatingSubmitted(rating); }));
            }); }; };
        }
    ...
    var LikeRatingController = (function () {
        function LikeRatingController(model, viewModel, commandProcessor) {
            ...
            viewModel.personalRating = model.personalRating;
            viewModel.summarizedRatings = model.summarizedRatings;
            viewModel.select = function (ratingValue) { return function () { return setTimeout(function () {
                commandProcessor.processCommand(new SelectLikeRatingCommand(ratingValue, function () { return _this.onRatingSubmitted(ratingValue); }));
            }); }; };
        }
